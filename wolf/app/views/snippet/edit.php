...
<form action="<?php echo $action == 'edit' ? get_url('snippet/edit/' . $snippet->id) : get_url('snippet/add'); ?>" method="post">
    ...
    <div class="settings-pane">
        <div class="form-inline page-filter-area">
    ...
    <fieldset class="buttons form-inline smart">
        ...
        <?php endif; ?>
        <a class="btn btn-default edit-cancel" href="<?php echo get_url('snippet'); ?>"><span class="glyphicon glyphicon-remove"></span> <?php echo __('Cancel'); ?></a>
    </fieldset>    
